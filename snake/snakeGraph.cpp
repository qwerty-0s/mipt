...
Game_Window::Game_Window(int w, int h, snake * p1, snake * p2, int cell_size_): Fl_Window(w, h, "Snake Game"), player1(p1), player2(p2),
...
BackgroundWindow::BackgroundWindow(int w, int h,
    const char * title): Fl_Window(w, h, title), background(w, h) {
    end();
}
